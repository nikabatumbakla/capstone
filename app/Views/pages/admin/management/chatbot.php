        ...
        <div class="container-fluid p-4" style="font-size:11px;">
            ...
            <div class="row g-4 mb-4">
                <div class="col-md-4">
                    <div class="inventory-kpi-card position-relative">
                        <i class="fas fa-comment-dots position-absolute text-muted" style="top:10px; right:12px; font-size:10px;"></i>
                        <small class="text-muted fw-bold d-block mb-1">TOTAL BOT QUERIES</small>
                        <h3 class="fw-bold mb-0"><?= $count_queries ?></h3>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="inventory-kpi-card position-relative">
                        <i class="fas fa-exclamation-triangle position-absolute text-muted" style="top:10px; right:12px; font-size:10px;"></i>
                        <small class="text-muted fw-bold d-block mb-1">PENDING ESCALATIONS</small>
                        <h3 class="fw-bold mb-0 text-danger"><?= $count_escalations ?></h3>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="inventory-kpi-card position-relative" style="background:#212529; color:#fff;">
                        <small class="d-block mb-1" style="color:#aaa;">ENGINE STATUS</small>
            ...
            <div class="custom-table-container">
                <ul class="nav nav-pills mb-4 bg-light p-1 rounded-pill border" id="botTabs">
                    <li class="nav-item flex-grow-1"><button type="button" class="nav-link active rounded-pill w-100 fw-bold" style="font-size:11px;" data-bs-toggle="pill" data-bs-target="#tab-intents">Response Intents</button></li>
                    <li class="nav-item flex-grow-1"><button type="button" class="nav-link rounded-pill w-100 fw-bold" style="font-size:11px;" data-bs-toggle="pill" data-bs-target="#tab-escalations">Staff Fallback Queue</button></li>
                </ul>
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="tab-intents">
                        <div class="d-flex justify-content-between mb-3 align-items-center flex-wrap gap-2">
                            ...
                            <div class="d-flex gap-2">
                                ...
                                <button type="button" class="btn btn-sm btn-maroon rounded-pill px-4" data-bs-toggle="offcanvas" data-bs-target="#intentDrawer" id="btnAddNewIntent"><i class="fas fa-plus me-1"></i>Add Intent</button>
                            </div>
                        </div>
                    ...
                    <div class="tab-pane fade" id="tab-escalations">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <div class="d-flex gap-2">
                                <button type="button" class="btn btn-sm rounded-pill px-3 esc-status-btn active" data-status="escalated">Awaiting Staff</button>
                                <button type="button" class="btn btn-sm rounded-pill px-3 esc-status-btn" data-status="in_progress">In Progress</button>
                                <button type="button" class="btn btn-sm rounded-pill px-3 esc-status-btn" data-status="resolved">Resolved</button>
                            </div>
                        </div>
                        <div class="table-responsive">
                            <table class="table table-hover align-middle">
                                <thead class="table-dark"><tr><th class="ps-4">Conversation</th><th>Client</th><th>Date Received</th><th>Status</th><th class="text-center">Action</th></tr></thead>
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="chatDrawer" style="width: 450px;">
    ...
    <div class="offcanvas-body d-flex flex-column p-0">
        ...
        <div class="p-3 border-top bg-white">
            <div id="resolvedNotice" class="text-center text-muted py-2" style="display:none; font-size:11px;">This conversation is resolved — no further replies needed.</div>
            <div class="d-flex justify-content-end mb-2" id="resolveBtnWrap">
                <button type="button" class="btn btn-xs btn-outline-success rounded-pill px-3" id="btnResolveEscalation"><i class="fas fa-check me-1"></i>Mark Resolved</button>
            </div>
