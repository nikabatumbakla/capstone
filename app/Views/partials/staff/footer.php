<!-- jQuery and Bootstrap JS -->
    ...
    <script src="<?= base_url('public/js/staff/header_notifications.js') ?>"></script>
    <script>
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="myProfileDrawer" style="width: 450px;">
    <div class="offcanvas-header border-bottom bg-light">
        <h6 class="fw-bold mb-0"><i class="fas fa-user-circle me-2"></i>My Profile</h6>
...
<?= view('partials/staff/quick_lookup_widget') ?>
