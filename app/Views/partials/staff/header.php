<nav class="navbar main-header px-3 shadow-sm bg-white">
    ...
    <div class="header-icons d-flex align-items-center">
        ...
        <a href="<?= base_url('staff/operations/pos') ?>" target="_blank" rel="noopener" class="btn btn-sm btn-maroon rounded-pill px-3 me-3 d-flex align-items-center shadow-sm" style="font-size: 10px; height: 32px; font-weight: 700; text-decoration: none;">
