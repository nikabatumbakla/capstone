<nav class="navbar main-header px-3 shadow-sm bg-white">
    <div class="d-flex align-items-center">
        ...
        <div class="breadcrumb-area">
            <span class="text-muted small">Robin Rose Trading — Medical Supply</span>
        </div>
    </div>
    ...
    <div class="header-icons d-flex align-items-center">
        ...
        <a href="<?= base_url('staff/operations/pos') ?>" class="btn btn-sm btn-maroon rounded-pill px-3 me-3 d-flex align-items-center shadow-sm" style="font-size: 10px; height: 32px; font-weight: 700; text-decoration: none;">
