...
<section class="section">
    <div class="section-container">
            ...
            <div class="contact-info">
                <div class="contact-info-card">
                    ...
                    <div class="contact-method">
                        ...
                        <div>
                            ...
                            <strong><a href="tel:<?= esc($contact->phone ?? '') ?>" style="color:var(--blue)"><?= esc($contact->phone ?? '') ?></a></strong>
                        </div>
                    </div>
                    <div class="contact-method">
                        ...
                        <div>
                            ...
                            <strong><a href="mailto:<?= esc($contact->email ?? '') ?>" style="color:var(--blue)"><?= esc($contact->email ?? '') ?></a></strong>
                        </div>
                    </div>
                    <div class="contact-method">
                        ...
                        <div>
                            ...
                            <strong><?= esc($contact->address ?? '') ?></strong>
                        </div>
                    </div>
                    <div class="contact-method">
                        ...
                        <div>
                            ...
                            <strong><?= esc($contact->business_hours ?? '') ?></strong>
                        </div>
                    </div>
                </div>
                ...
                <div class="contact-info-card">
                    ...
                    <div style="display:flex;gap:0.8rem;flex-wrap:wrap;">
                        ...
                        <a href="<?= esc($contact->facebook_url) ?>" target="_blank" style="display:flex;align-items:center;gap:8px;padding:0.6rem 1rem;background:var(--cream);border-radius:8px;color:var(--blue);font-size:0.88rem;font-weight:600;">
                            <i class="fab fa-facebook-f" style="color:#1877f2"></i> Facebook
                        </a>
                        <?php endif; ?>
                        <?php if(!empty($contact->instagram_url)): ?>
                        <a href="<?= esc($contact->instagram_url) ?>" target="_blank" style="display:flex;align-items:center;gap:8px;padding:0.6rem 1rem;background:var(--cream);border-radius:8px;color:var(--blue);font-size:0.88rem;font-weight:600;">
                            <i class="fab fa-instagram" style="color:#e1306c"></i> Instagram
                        </a>
                        <?php endif; ?>
                        <?php if(!empty($contact->viber_number)): ?>
                        <a href="tel:<?= esc($contact->viber_number) ?>" style="display:flex;align-items:center;gap:8px;padding:0.6rem 1rem;background:var(--cream);border-radius:8px;color:var(--blue);font-size:0.88rem;font-weight:600;">
                ...
                <div class="contact-info-card">
                    ...
                    <?php if(!empty($contact->map_embed_url)): ?>
                    <iframe class="map-embed" src="<?= esc($contact->map_embed_url, 'attr') ?>" allowfullscreen="" loading="lazy"></iframe>
                    <?php endif; ?>
                    <p style="font-size:0.82rem;color:var(--gray);margin-top:0.5rem;"><?= esc($contact->full_address ?? '') ?></p>
                </div>
            </div>
        ...
        <!-- Quick Contact Table (static — response-time policy, not content copy) -->
