    ...
    public function delete_product($product_id)
{
    ...
    return redirect()->to('admin/operations/inventory/stock-management')->with('success', 'Product deleted.');
}
    ...
    public function adjust_stock()
{
    ...
    return redirect()->to('admin/operations/inventory/stock-management')->with('success', 'Adjustment Complete.');
}
...
public function update_product_info()
{
    ...
    return redirect()->to('admin/operations/inventory/stock-management')->with('success', 'Product info updated.');
}
public function create_batch()
{
    ...
    return redirect()->to('admin/operations/inventory/stock-management')->with('success', 'Stock batch added.');
}
