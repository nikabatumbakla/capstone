...
class Procurement extends BaseController
{
    public function suppliers()
    {
        ...
        return view('pages/admin/procurement/suppliers', $data);
    }
...
public function purchase_orders()
    {
        ...
        $data['fullname'] = session()->get('full_name');
        $data['page_name'] = "procurement"; 
        return view('pages/admin/procurement/purchase_orders', $data);
    }
...
public function goods_receipt()
{
    ...
    $data['fullname'] = session()->get('full_name');
    $data['page_name'] = "procurement";
    return view('pages/admin/procurement/goods_receipt', $data);
}
