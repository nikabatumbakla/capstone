...
class Stock extends BaseController
{
    ...
    // Replaces get_details($batchId) — now returns the whole product's batch breakdown
    public function get_product_batches($productId)
    {
        $product = $this->stockModel->getProductBatches((int) $productId);
