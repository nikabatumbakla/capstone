                    ...
                    content.innerHTML = `
                        <form action="${BASE_URL}/supplier/inventory/catalog/update" method="POST">
                            ...
                            <div class="p-3 bg-light rounded-4 mb-3">
                                ...
                                <small class="text-muted">Barcode: ${data.barcode_value}</small>
                            </div>
                            <div class="row g-3 mb-3">
                                <div class="col-6"><label class="formal-label">Cost Price (₱) *</label><input type="number" step="0.01" min="0.01" name="unit_cost" class="formal-input" value="${data.unit_cost}" required></div>
                                <div class="col-6"><label class="formal-label">Minimum Order Qty</label><input type="number" min="1" name="minimum_order_qty" class="formal-input" value="${data.minimum_order_qty}"></div>
                            </div>
                            <div class="mb-4"><label class="formal-label">Lead Time (days)</label><input type="number" min="1" name="lead_time_days" class="formal-input" value="${data.lead_time_days}"></div>
